...
const recentArticles: Article[] = [
    {
        ...
        description: '本文将介绍如何使用 Next.js 和 Mantine UI 构建一个现代化的博客系统，包括性能优化、SEO 优化等方面...',
        date: '2024-01-20',
        tags: ['Next.js', 'React', '博客开发'],
        imageUrl: 'https://cdn.shopify.com/s/files/1/0754/2767/6508/files/what_is_a_jpg_file_480x480.jpg?v=1683282723',
        views: 756,
        author: '小明'
    },
    {
